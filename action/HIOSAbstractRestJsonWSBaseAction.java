...
public abstract class HIOSAbstractRestJsonWSBaseAction extends HIOSAbstractWSBaseAction{
	...
	protected abstract List<JsonResponseObj> executeJsonService(Map<String, String[]> Params) throws HiosRuntimeException, HIOSException ;
	...
	protected String executeAction(HashMap<String, Object> message) throws HiosRuntimeException, HIOSException {
		...
		try {
			resultList = executeJsonService(params);
...
*/		logger.info(this.getClass().getName() +": processed in "+ (System.currentTimeMillis() - startTime) + " ms.");
		return response;
	}
